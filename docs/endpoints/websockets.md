...
Top bids are SSZ encoded and compatible with the [Titan Relay specs](https://docs.titanrelay.xyz/builders/builder-integration#websocket-topbid-stream). Prefer **v2**: same 188-byte payload, nanosecond timestamps. v1 is unchanged and still uses millisecond timestamps.

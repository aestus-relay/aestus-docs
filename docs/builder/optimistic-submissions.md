...
Builders will need to supply collateral in a transaction to `builder.aestus.eth` and must have a recent track record without failed bids.

To use this service: please reach out to us via telegram, email, or twitter.
